...
<head>
 ...
 <?php print $head; ?>
  ...
  <?php
	...
	if (!is_ssl()) {
		echo '<link type="text/css" rel="stylesheet" media="all" href="http://oregonstate.edu/tools/css/yui/2.7.0/reset-fonts-grids.css" />';
		echo '<link type="text/css" rel="stylesheet" media="all" href="http://oregonstate.edu/tools/css/osu-base/0.2-beta/osu-base.css" />';
		echo '<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>';
		
	} else {
		echo '<link type="text/css" rel="stylesheet" media="all" href="https://osulibrary.oregonstate.edu/files/osu_base_css/reset-fonts-grids.css" />';
		echo '<link type="text/css" rel="stylesheet" media="all" href="https://osulibrary.oregonstate.edu/files/osu_base_css/osu-base.css" />';
		echo '<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8/themes/base/jquery-ui.css" rel="stylesheet" type="text/css"/>';
	}
 ...
 <?php 
	if (!is_ssl()) {
		...
		echo '<script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js" type="text/javascript"></script>';
	} else {
		echo '<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js" type="text/javascript"></script>';
		echo '<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js" type="text/javascript"></script>';
	}
 ...
 <script type="text/javascript">
  ...
  <?php
	// Top Hat JS
	print $scripts;
    //include ('http://oregonstate.edu/u_central/top-hat/osu-standard.php?secure=1&domain=osulibrary.oregonstate.edu&site_name=OSU%20Libraries&render=js&jquery=1');
  ?>
...
<![endif]-->
<!--[if IE 8]>
<div id="ie8" class="iefix">
<![endif]-->
<!--[if IE 9]>
<div id="ie9" class="iefix">
<![endif]-->
	...
	<?php
		...
		if($site_name == 'Guin')
			$color = '6784A0';
		else if($site_name == 'Cascades')
			$color = '0069A7';
		include ('http://oregonstate.edu/u_central/top-hat/osu-standard.php?secure=1&domain=osulibrary.oregonstate.edu&site_name=OSU%20Libraries&search_box=0&border_color=' . $color . '&render=hat');
		print $top_hat;
	?>
		...
		<div id="page" class="<?php echo $page_class; ?>">
			<div id="page-inner">
				...
				<div id="bd">
					...
					<?php if ($breadcrumb && $title != "Search Site"): ?>

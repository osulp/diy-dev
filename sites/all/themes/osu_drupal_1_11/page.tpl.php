...
<body class="<?php print $body_classes; ?>">
	...
	<?php if ($primary_links || $secondary_links || $top_horizontal_bar): ?>
		<div id="skip-to-nav">
	    	<a href="#navigation">
		...
		<div id="page">
			<div id="page-inner">
				...
				<div id="hd" role="banner">
					...
					<!-- START DRUPAL HEADER -->
					<!--  check for short header option in theme settings -->
					<?php if (!$is_front && theme_get_setting('osu_second_header_type') == 'short'): ?>
						<!-- START SHORT HEADER -->
						<div id="header" class="short-header">
					...
					<?php if ($search_box || $primary_links || $secondary_links || $top_horizontal_bar): ?>
						<div id="top-horizontal-bar">
							<div id="top-horizontal-bar-inner" class="clear-block region region-top_horizontal_bar">
						...
						<div class="yui-b">
							...
							<!--  END CHECK FOR RIGHT COL -->
										...
										<div class="interior">
											...
											<!-- START DRUPAL MAIN -->		
											<div id="main">
												<div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $top_horizontal_bar) { print ' with-navbar'; } ?>">
				...
				<div id="ft" role="contentinfo">
					...
					<p class="osu-footer-text">
						<a href="http://oregonstate.edu/about/copyright">Copyright</a>
						&#169; <?php echo date('Y'); ?> Oregon State University | 
						<a href="http://oregonstate.edu/about/disclaim">Disclaimer</a>
					</p>

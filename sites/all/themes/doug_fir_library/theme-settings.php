 ...
 *   The form state.
 */
function doug_fir_library_form_system_theme_settings_alter(&$form, $form_state) {

  $themes = list_themes();
  
  $variants = $themes['doug_fir_library']->info['variants'];
  $variant_text = 'Select which osu theme variant you want to use: <br />' .

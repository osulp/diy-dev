...
function addMaterial () {
	$("#materials").append("<div class='material" + materialsVar + "'><h3 class='materialTypeHeading'>Material " + materialsVar + ": <span></span></h3><p><label>Material Type: <select name='" + materialsVar + "_Type' class='materialType'><option></option><option value='library material'>Library Material</option><option value='personal material'>Personal Material</option><option value='reserve binder'>Reserve Binder</option><option value='media booking'>Media Booking</option><option value='reserve purchase request'>Reserve Purchase Request</option></select></label></p><div class='loan_copies'><p><label>Loan Period: <select name='" + materialsVar + "_Loan'><option value='3 hour'>3 hour</option><option value='1 day'>1 day</option><option value='2 day'>2 day</option></select></label></p><p><label># Copies: <select name='" + materialsVar + "_Copies'><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option></select></label></p></div><div class='library_material'><p><label>Call Number: <input type='text' size='30' name='" + materialsVar + "_Call+Number' /></label></p><p><label>Title: <input type='text' size='30' name='" + materialsVar + "_Title' /></label></p><p><label>Author: <input type='text' size='30' name='" + materialsVar + "_Author' /></label></p></div><div class='personal_material'><p><label>Title: <input type='text' size='30' name='" + materialsVar + "_Title+' /></label></p><p><label>Author: <input type='text' size='30' name='" + materialsVar + "_Author+' /></label></p><p><label>Edition/Publication Year: <input type='text' size='30' name='" + materialsVar + "_Year' /></label></p></div><div class='reserve_binder'><p><label>Title: <input type='text' size='30' name='" + materialsVar + "_Title++' /></label></p><p><em>Please submit the same number of copies of each article for reserve reading packets.</em></p></div><div class='media_booking'><p><label>Title: <input type='text' size='30' name=" + materialsVar + "_Title+++' /></label></p><p><label>Library Call Number: <input type='text' size='30' name=" + materialsVar + "_Call+Number++' /></label></p><p><label>Date/Time Needed:<input type='text' size='30' name="+ materialsVar + "_Date+' /></label></p></div><div class='reserve_purchase_request'><p><label>Title: <input type='text' size='30' name='" + materialsVar + "_Title+++' /></label></p><p><label>Author: <input type='text' size='30' name='" + materialsVar + "_Author++' /></label></p><p><label>Edition/Publication Year: <input type='text' size='30' name='" + materialsVar + "_Year++' /></label></p><p><label>Publisher: <input type='text' size='30' name='" + materialsVar + "_Publisher' /></label></p><p><label>ISBN: <input type='text' size='30' name='" + materialsVar + "_ISBN' /></label></p></div></div>");
	...
	$(".materialType").change(function() {
		...
		if (heading == "Reserve Binder")
			var heading = "Reserve Binder";
...
function addCourse() {
	$("#course").append("<p class='nomargin'><label>Course Name " + courses + ": <input type='text' size='30' name='COURSENAME" + courses + "' /></label><p class='nomargin'><label>Course Number " + courses + ": <input type='text' size='30' name='COURSENUMBER" + courses + "' /></label></p>");
	courses++;
}
